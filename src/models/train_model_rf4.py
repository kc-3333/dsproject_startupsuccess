...
df = pd.read_csv(r'C:\Users\User\Desktop\Projects\Data Science\project_startup_success\data\processed\df3_fe.csv')
...
rf_classifier1 = RandomForestClassifier(class_weight=class_weights)
...
# rf4 vs rf3 - after z normalization yield better result